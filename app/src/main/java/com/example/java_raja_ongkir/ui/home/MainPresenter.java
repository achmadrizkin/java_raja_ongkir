...
import com.example.java_raja_ongkir.network.Api;
import com.example.java_raja_ongkir.network.ApiService;
import com.example.java_raja_ongkir.network.Helper;
...
public class MainPresenter implements MainContract.Presenter {
    ...
    public MainPresenter(MainContract.View view) {
        this.view = view;
        endpoint = Api.getUrl().create(ApiService.class);
    }
